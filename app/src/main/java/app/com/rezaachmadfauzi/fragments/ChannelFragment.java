package app.com.rezaachmadfauzi.fragments;
...
import app.com.rezaachmadfauzi.DetailsActivity;
import app.com.rezaachmadfauzi.R;
import app.com.rezaachmadfauzi.adapters.VideoPostAdapter;
...
public class ChannelFragment extends Fragment {
    ...
    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyDT8dxX9qz0zbCj9V1112hu-Lhl0qUl01Y";//here you should use your api key for testing purpose you can use this api also
    private static String CHANNEL_ID = "UCb_kshGodseYhLPcDtxWv5w"; //here you should use your channel id for testing purpose you can use this ID also
